...
- [Awesome deep learning papers](https://github.com/terryum/awesome-deep-learning-papers#optimization--training-techniques)

- [Evolution strategies vs. reinforcement learning](https://blog.openai.com/evolution-strategies/)

- [Building _safe_ (encrypted) AI](http://iamtrask.github.io/2017/03/17/safe-ai/)

- [A tutorial on active learning](http://hunch.net/~active_learning/active_learning_icml09.pdf)
